...
<head>
    ...
    <title>Validasi Surat Penerimaan Magang</title>
    <style>
        body {
        ...
        .status.invalid {
            background: #fee2e2; /* tetap merah untuk invalid */
            color: #991b1b;
        ...
        @media screen and (max-width: 480px) {
            ...
            .header img {
                max-width: 70px; /* sedikit lebih kecil di HP */
            }
            .header .title h2 {
                font-size: 16px;
            }
...
<body>
    <div class="container">
        <div class="header">
            <!-- Logo Provinsi Riau (kiri) -->
            <img src="{{ asset('images/logo-riau.png') }}" alt="Logo Provinsi Riau">

            <!-- Judul Tengah -->
            <div class="title">
                <h2>Validasi Surat Penerimaan Magang</h2>
                <p>PEMERINTAH PROVINSI RIAU</p>
                <p>DINAS KEBUDAYAAN</p>
            </div>
        </div>
        ...
        <div class="status {{ $pengajuan->status === 'diterima' ? 'valid' : 'invalid' }}">
            {{ $pengajuan->status === 'diterima' ? '✅ Surat ini VALID' : '❌ Surat ini TIDAK VALID' }}
        </div>
    </div>
</body>
</html>
